...
/* Copyright (c) xxxx, 2023 Rexx Language Association. All rights reserved.,, */
...
do l = 1 to 20
  ...
  if left(code[l],2) = "/*", pos( "Copyright (c)", code[l] ) > 0 then do
    if pos( "Rexx Language Association", code[l] ) > 0 then do
      chgd = 1
      line = code[l]
